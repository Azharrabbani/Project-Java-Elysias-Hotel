...
public class UpdateProfile extends javax.swing.JFrame {
     ...
     */
    public UpdateProfile(Guest guest, User user) {
        initComponents();
        this.guest = guest;
        this.user = user;
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String noTel = jTextField2.getText();
        ...
        guest.UpdateProfile(user);
        this.dispose();
        JOptionPane.showMessageDialog(null, "Success Update Account", "Info", JOptionPane.INFORMATION_MESSAGE);
        Profile profileDua = new Profile(guest, user);
        profileDua.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateProfile(guest, user).setVisible(true);
            }
        });
    }
